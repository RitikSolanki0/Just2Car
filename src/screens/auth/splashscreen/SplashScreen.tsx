...
import React, { useEffect } from 'react';
import { View, Text, StatusBar, Image } from 'react-native'; // Image import kiya
import Animated, { 
  useSharedValue, 
  useAnimatedStyle, 
  withTiming, 
...
const SplashScreen = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      <Animated.View style={[styles.logoContainer, animatedStyle]}>
        {/* --- Text hatakar Image lagayi --- */}
        <Image 
          source={require('../../../assets/images/Just2carLogo.png')} // Apne PNG ka sahi path dena
