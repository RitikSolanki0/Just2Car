...
export const styles = StyleSheet.create({
  ...
  mainImg: { width: width, height: 250, resizeMode: 'cover' },

  content: { padding: 20 },
  mainInfo: { marginBottom: 20 },
  title: { fontFamily: Fonts.bold, fontSize: 24, color: Colors.primary },
  rowBetween: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginTop: 5 },
  price: { fontFamily: Fonts.bold, fontSize: 22, color: Colors.black },
  locSubText: { fontFamily: Fonts.medium, fontSize: 14, color: 'gray', marginTop: 5 },

  daysBadge: { backgroundColor: '#FEE2E2', paddingHorizontal: 12, paddingVertical: 6, borderRadius: 20, borderWidth: 1, borderColor: '#EF4444' },
  daysText: { color: '#DC2626', fontFamily: Fonts.bold, fontSize: 12 },

  analyticsBar: { flexDirection: 'row', justifyContent: 'space-between', backgroundColor: '#F3F4F6', padding: 15, borderRadius: 15, marginBottom: 20, marginTop: 10 },
  analyticsItem: { flexDirection: 'row', alignItems: 'center', flex: 1 },
  analyticsIconBg: { width: 40, height: 40, borderRadius: 12, backgroundColor: 'white', justifyContent: 'center', alignItems: 'center', marginRight: 10 },
  analyticsLabel: { fontSize: 10, color: 'gray', fontFamily: Fonts.medium },
  analyticsValue: { fontSize: 16, color: 'black', fontFamily: Fonts.bold },

  videoBtn: { backgroundColor: Colors.primary, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', padding: 15, borderRadius: 12, marginBottom: 20 },
  videoBtnText: { color: 'white', fontFamily: Fonts.bold, marginLeft: 10 },

  statusCard: { padding: 18, borderRadius: 16, marginBottom: 20, borderWidth: 1 },
  row: { flexDirection: 'row', alignItems: 'center' },
  statusHeading: { fontFamily: Fonts.bold, fontSize: 16, marginLeft: 10 },
  statusDescription: { fontFamily: Fonts.regular, fontSize: 13, color: '#4B5563', lineHeight: 20, marginTop: 5 },
  inlineConfirmBtn: { backgroundColor: Colors.secondary, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', paddingVertical: 14, borderRadius: 12, marginTop: 15 },
  inlineBtnText: { color: 'white', fontFamily: Fonts.bold, fontSize: 14, marginRight: 10 },

  sectionTitle: { fontFamily: Fonts.bold, fontSize: 18, color: 'black', marginBottom: 15, marginTop: 10 },
  grid: { flexDirection: 'row', flexWrap: 'wrap' },
  gridItem: { width: '50%', marginBottom: 20 },
  itemLabel: { fontSize: 11, color: '#9CA3AF', fontFamily: Fonts.regular },
  itemValue: { fontSize: 14, color: 'black', fontFamily: Fonts.semiBold, marginTop: 2 },

  descBox: { backgroundColor: '#F9FAFB', padding: 15, borderRadius: 12, marginBottom: 20 },
  descriptionText: { fontFamily: Fonts.regular, fontSize: 14, color: '#4B5563', lineHeight: 22 },

  infoBox: { backgroundColor: '#F3F4F6', padding: 15, borderRadius: 12 },
  infoLabel: { fontSize: 11, color: 'gray', fontFamily: Fonts.medium },
  infoValue: { fontFamily: Fonts.bold, fontSize: 14, color: 'black' },
